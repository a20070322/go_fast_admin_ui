 ...
 * @LastEditTime: 2021-08-18 17:19:18
 * @LastEditors: 赵忠洋
 * @Description:
 * @FilePath: /goAdminUI2/src/pages/system/menu/components/MenuFormUpdate.tsx
 */
import { useRequest } from '@/.umi/plugin-request/request';
import { MenuTreeListItem, menuTreeList, menuCreate, MenuCreateReq, MenuUpdateReq, menuUpdate } from '@/apis/admin_menu';
...
interface Props {
  ...
  onSuccess?: () => void
  itemData: MenuTreeListItem
}

const MenuFormUpdate = (props: Props) => {
  // 全部权限获取
  ...
  useEffect(() => {
    ...
    menuReq.run()
    formRef.current?.setFieldsValue(props.itemData)
    setParent(findItem(menuReq.data || [], props.itemData.id))
  }, [visible])
  return (
    <DrawerForm<MenuUpdateReq>
              ...
              <ProForm.Group>
                ...
                }
                {
                  ([1, 2, 3].includes(data.type)) && (
                    <ProFormSwitch width="md" name="is_show" label="是否展示" />
                  )
                }
